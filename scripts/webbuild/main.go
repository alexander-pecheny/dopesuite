...
func targets() []target {
	return []target{
		{"dope", func() []api.BuildOptions {
			return []api.BuildOptions{
				{
					EntryPointsAdvanced: entries("dope/dope/web/ts/pages/", "od", "si", "brain", "host", "viewer"),
					Bundle:              true,
				...
				{
					EntryPointsAdvanced: entries("dope/dope/web/ts/",
						"entry-model", "match-table", "state-sync", "game-page", "widgets", "stage-cache", "stats-sync", "fest-grid", "brain-stats", "group-stats",
