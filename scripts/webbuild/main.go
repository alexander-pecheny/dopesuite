	...
	return []target{
		{"dope", func() []api.BuildOptions {
			return []api.BuildOptions{
				...
				{
					EntryPointsAdvanced: entries("dope/dope/web/ts/",
						"entry-model", "sheet-cursor", "cells", "score-table", "venue", "standings", "fest-roster", "ek-stats", "state-sync", "game-page", "widgets", "stage-cache", "stats-sync", "fest-grid", "brain-stats", "group-stats", "game-tabs",
