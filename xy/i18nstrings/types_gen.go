...
func (s Strings) Lookup(id string) (string, bool) {
	...
	case "card.slot.add_reserve":
		return s.Card.Slot.AddReserve(), true
	case "card.slot.add_reserve_title":
		return s.Card.Slot.AddReserveTitle(), true
