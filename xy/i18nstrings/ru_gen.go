...
var RU = Strings{
	...
	Board: BoardStrings{
		...
		Copy: BoardCopyStrings{
			Done:         func() string { return "Доска клонирована." },
			Failed:       func(error string) string { return fmt.Sprintf("Не удалось клонировать: %s", error) },
			GenPass:      func() string { return "Сгенерировать пароль" },
			Label:        func() string { return "Клонировать доску" },
			...
			Submit: func() string { return "Клонировать" },
			Title: func() string {
				return "Создать копию доски со всеми списками и карточками"
			},
		},
