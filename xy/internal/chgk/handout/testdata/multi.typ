...
#qlabel[Раздаточный материал к вопросу 1]

#handout(3, 1, 3, 1, 1.5mm, 66.0mm, 2mm, 5.927mm, true, true, text(size: 14pt)[Первый])

#qlabel[Раздаточный материал к вопросу 2]

#handout(4, 1, 4, 1, 1.5mm, 49.5mm, 2mm, 5.927mm, false, true, text(size: 14pt)[Второй])