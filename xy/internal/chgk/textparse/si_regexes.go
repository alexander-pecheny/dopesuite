...
// question's number in SI is its point value, and a troika's is 1, 2 or 3).
...
var (
	...
	// reSiThemeAuthored is an inline theme header, "2. Zero (David Edjibia)":
...
// siQuestionNumbers are the point values an SI question can be worth; a line
...
var (
	...
	// reTroikaMultiforaQuestion is the multifora variant's question marker:
	// "N.M." (theme index, question index), sometimes spelled "Question N.M."
	// or, in the reserve pool, "ResN.M.". The dot after M is required, so a bare
...
// troikaQuestionNumbers: a troika theme holds three questions.
