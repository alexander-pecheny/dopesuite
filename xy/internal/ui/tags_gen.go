...
var MountJoinRequests = Attr{Name: "kind", Value: "join-requests"}
var MountInviteList = Attr{Name: "kind", Value: "invite-list"}
var MountInviteForm = Attr{Name: "kind", Value: "invite-form"}
var MountJoinBody = Attr{Name: "kind", Value: "join-body"}
