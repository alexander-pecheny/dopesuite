...
| `fest-grid.ts` | ~860 | The Сетка — a column per stage, бой boxes and Group tables built of the same `.grid-slot-cell` cells in one `.grid-box`, reseed panels, truncated team names |
