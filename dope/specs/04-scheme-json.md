...
- Пользовательский импорт схемы больше не принимает массив `teams` верхнего уровня. Команды и составы загружаются только из `rating.chgk.info`; чтобы изменить список участников, нужно переимпортировать рейтинг.
