...
type AdminPasswordResetStrings struct {
	ColPassword   func() string
	Lead          func() string
	LinkLabel     func() string
	LinkLead      func(username string) string
	Name          func() string
	NoSuchUser    func(username string) string
	ResetLink     func() string
	Submit        func() string
	SystemUser    func() string
	Title         func() string
	UsernameLabel func() string
}
...
type AuthLoginStrings struct {
	...
	CodeNotFound       func() string
	CredentialsInvalid func() string
	CredentialsMissing func() string
	PasswordWrong      func() string
	SystemUser         func() string
	TelegramLinked     func() string
	TgNotConfigured    func() string
	UsernameInvalid    func() string
}

type AuthPasswordStrings struct {
	CurrentWrong func() string
	TooLong      func(n string) string
	TooShort     func(n string) string
}

type AuthResetStrings struct {
	ConfirmPlaceholder func() string
	Lead               func(username string) string
...
type BrainPodStrings struct {
	BlockRound func(n string) string
}
...
type FestDrawStrings struct {
	None    func() string
	Pending func() string
	Seat    func(bout string) string
	Title   func() string
}
...
type GalleryHamsaStrings struct {
	Title func() string
}
...
type GamesEsStrings struct {
	Label func() string
	Short func() string
}

type GamesHamsaStrings struct {
	Label func() string
}
...
// HamsaStrings is the hamsa Surface.
type HamsaStrings struct {
...
type HamsaDrawStrings struct {
	None func() string
}

type HamsaProtocolStrings struct {
	AnswerTitle   func(team string, theme string, value string) string
	Bet           func() string
	BetTitle      func(team string) string
	Finished      func() string
	Plus          func() string
	QuestionCount func(n string) string
	Seat          func(n string) string
	Theme         func(n string) string
	Unseated      func() string
}

type HamsaRoundStrings struct {
	Dark           func() string
	HalfDark       func() string
	Head           func(n string, name string) string
	HeadMultiplied func(n string, name string, multiplier string) string
	Light          func() string
	Personal       func() string
	Shootout       func() string
	Team           func() string
}

type HamsaTableStrings struct {
	Bouts    func() string
	Empty    func() string
	First    func() string
	Place    func() string
...
type HostGamesStrings struct {
	...
	EntrantTroika        func(name string) string
...
type HostRosterStrings struct {
	...
	ConflictCancel        func() string
	ConflictChoiceDrop    func() string
	ConflictChoiceLabel   func() string
	ConflictChoiceMerge   func(id string, team string) string
	ConflictGames         func(games string) string
	ConflictHint          func() string
	ConflictNoCandidates  func() string
	ConflictSubmit        func() string
	ConflictTeam          func(number string, team string) string
	ConflictTitle         func() string
	DeleteBtn             func() string
	...
	FlagsPlaceholder      func() string
	FlagsSavedNotice      func() string
...
type HostTroikasStrings struct {
	AddSubhead       func() string
	AddSubmit        func() string
...
// MatchopsStrings is the matchops Surface.
type MatchopsStrings struct {
	Seating MatchopsSeatingStrings
}

type MatchopsSeatingStrings struct {
	NotInRoster func() string
	Repeated    func() string
...
type ReplayParseStrings struct {
	...
	BetNotHere           func(name string) string
...
type ResolverDrawStrings struct {
	AlreadySeated func() string
	NotACandidate func() string
}
...
type SchemeValidateStrings struct {
	...
	SlugRequired      func() string
	StageCodeDup      func(code string) string
	StageCodeRequired func() string
	StageNoMatches    func(stage string) string
	StageType         func(kind string) string
	StagesRequired    func() string
...
type ScreenDivisionStrings struct {
	All   func() string
	Label func() string
}
...
type StructurePlacementStrings struct {
	BlockRoundsMin      func() string
	DealUnknown         func(deal string) string
	DrawSeat            func() string
	MatchSizeMissing    func() string
...
type StructureSeStrings struct {
	...
	BlockRoundNth           func(n string) string
	BlockRoundSemifinals    func() string
	Bronze                  func() string
	BronzeBout              func(n string) string
	FinalBout               func(n string) string
	MatchNthBlockRound      func(n string, index string) string
...
type StructureSwissStrings struct {
	...
	Pool                    func(wins string, losses string) string
...
type TroikaShootoutStrings struct {
	Add  func() string
	Drop func() string
	Head func(n string) string
}
...
type TroikaSwissStrings struct {
	Losses func() string
	Place  func() string
	Seed   func() string
	Wins   func() string
...
type TroikaWrittenStrings struct {
	Place      func() string
	Threes     func() string
	ThreesHint func() string
	Twos       func() string
	TwosHint   func() string
}
...
func (s Strings) Lookup(id string) (string, bool) {
	...
	case "admin.password_reset.col_password":
		return s.Admin.PasswordReset.ColPassword(), true
	case "admin.password_reset.lead":
		return s.Admin.PasswordReset.Lead(), true
	case "admin.password_reset.link_label":
		return s.Admin.PasswordReset.LinkLabel(), true
	case "admin.password_reset.name":
		return s.Admin.PasswordReset.Name(), true
	case "admin.password_reset.reset_link":
		return s.Admin.PasswordReset.ResetLink(), true
	case "admin.password_reset.submit":
		return s.Admin.PasswordReset.Submit(), true
	case "admin.password_reset.system_user":
		return s.Admin.PasswordReset.SystemUser(), true
	case "admin.password_reset.title":
		return s.Admin.PasswordReset.Title(), true
	case "admin.password_reset.username_label":
		return s.Admin.PasswordReset.UsernameLabel(), true
	...
	case "auth.login.code_missing":
		return s.Auth.Login.CodeMissing(), true
	case "auth.login.code_not_found":
		return s.Auth.Login.CodeNotFound(), true
	case "auth.login.credentials_invalid":
		return s.Auth.Login.CredentialsInvalid(), true
	case "auth.login.credentials_missing":
		return s.Auth.Login.CredentialsMissing(), true
	case "auth.login.password_wrong":
		return s.Auth.Login.PasswordWrong(), true
	case "auth.login.system_user":
		return s.Auth.Login.SystemUser(), true
	case "auth.login.telegram_linked":
		return s.Auth.Login.TelegramLinked(), true
	case "auth.login.tg_not_configured":
		return s.Auth.Login.TgNotConfigured(), true
	case "auth.login.username_invalid":
		return s.Auth.Login.UsernameInvalid(), true
	case "auth.password.current_wrong":
		return s.Auth.Password.CurrentWrong(), true
	case "auth.reset.confirm_placeholder":
		return s.Auth.Reset.ConfirmPlaceholder(), true
	case "auth.reset.link_invalid":
		return s.Auth.Reset.LinkInvalid(), true
	case "auth.reset.mismatch":
		return s.Auth.Reset.Mismatch(), true
	case "auth.reset.new_placeholder":
		return s.Auth.Reset.NewPlaceholder(), true
	case "auth.reset.submit":
		return s.Auth.Reset.Submit(), true
	case "auth.reset.title":
		return s.Auth.Reset.Title(), true
	case "auth.username.already_set":
		return s.Auth.Username.AlreadySet(), true
	case "auth.username.invalid":
		return s.Auth.Username.Invalid(), true
	...
	case "ek.seats.empty":
		return s.Ek.Seats.Empty(), true
	case "ek.seats.label":
		return s.Ek.Seats.Label(), true
	...
	case "ek.table.place":
		return s.Ek.Table.Place(), true
	case "ek.table.team":
		return s.Ek.Table.Team(), true
	case "ek.title":
	...
	case "export.hamsa.bet":
		return s.Export.Hamsa.Bet(), true
	case "export.hamsa.shootout":
		return s.Export.Hamsa.Shootout(), true
	case "export.od.city":
	...
	case "fest.draw.none":
		return s.Fest.Draw.None(), true
	case "fest.draw.pending":
		return s.Fest.Draw.Pending(), true
	case "fest.draw.title":
		return s.Fest.Draw.Title(), true
	...
	case "fest.metric.losses":
		return s.Fest.Metric.Losses(), true
	...
	case "fest.metric.seed":
		return s.Fest.Metric.Seed(), true
	case "fest.metric.stage":
		return s.Fest.Metric.Stage(), true
	...
	case "fest.metric.wins":
		return s.Fest.Metric.Wins(), true
	case "fest.metric_short.bouts":
		return s.Fest.MetricShort.Bouts(), true
	case "fest.metric_short.place_sum":
		return s.Fest.MetricShort.PlaceSum(), true
	...
	case "gallery.hamsa.title":
		return s.Gallery.Hamsa.Title(), true
	...
	case "gallery.section.chips":
		return s.Gallery.Section.Chips(), true
	case "gallery.section.divisions":
		return s.Gallery.Section.Divisions(), true
	...
	case "gallery.section.suggest":
		return s.Gallery.Section.Suggest(), true
	...
	case "games.es.label":
		return s.Games.Es.Label(), true
	case "games.es.short":
		return s.Games.Es.Short(), true
	case "games.hamsa.label":
		return s.Games.Hamsa.Label(), true
	...
	case "hamsa.draw.none":
		return s.Hamsa.Draw.None(), true
	case "hamsa.protocol.bet":
		return s.Hamsa.Protocol.Bet(), true
	case "hamsa.protocol.finished":
		return s.Hamsa.Protocol.Finished(), true
	case "hamsa.protocol.plus":
		return s.Hamsa.Protocol.Plus(), true
	case "hamsa.protocol.unseated":
		return s.Hamsa.Protocol.Unseated(), true
	case "hamsa.round.dark":
		return s.Hamsa.Round.Dark(), true
	case "hamsa.round.half_dark":
		return s.Hamsa.Round.HalfDark(), true
	case "hamsa.round.light":
		return s.Hamsa.Round.Light(), true
	case "hamsa.round.personal":
		return s.Hamsa.Round.Personal(), true
	case "hamsa.round.shootout":
		return s.Hamsa.Round.Shootout(), true
	case "hamsa.round.team":
		return s.Hamsa.Round.Team(), true
	case "hamsa.table.bouts":
		return s.Hamsa.Table.Bouts(), true
	case "hamsa.table.empty":
		return s.Hamsa.Table.Empty(), true
	case "hamsa.table.first":
		return s.Hamsa.Table.First(), true
	case "hamsa.table.place":
		return s.Hamsa.Table.Place(), true
	case "hamsa.table.place_sum":
		return s.Hamsa.Table.PlaceSum(), true
	case "hamsa.table.seed":
		return s.Hamsa.Table.Seed(), true
	case "hamsa.table.team":
		return s.Hamsa.Table.Team(), true
	case "hamsa.table.total":
		return s.Hamsa.Table.Total(), true
	case "hamsa.title":
		return s.Hamsa.Title(), true
	...
	case "host.dash.roster_troikas_link":
		return s.Host.Dash.RosterTroikasLink(), true
	...
	case "host.games.es_hint":
		return s.Host.Games.EsHint(), true
	case "host.games.hamsa_hint":
		return s.Host.Games.HamsaHint(), true
	...
	case "host.games.type_es":
		return s.Host.Games.TypeEs(), true
	case "host.games.type_hamsa":
		return s.Host.Games.TypeHamsa(), true
	...
	case "host.games.whole_roster_hint":
		return s.Host.Games.WholeRosterHint(), true
	...
	case "host.roster.col_flags":
		return s.Host.Roster.ColFlags(), true
	...
	case "host.roster.conflict_cancel":
		return s.Host.Roster.ConflictCancel(), true
	case "host.roster.conflict_choice_drop":
		return s.Host.Roster.ConflictChoiceDrop(), true
	case "host.roster.conflict_choice_label":
		return s.Host.Roster.ConflictChoiceLabel(), true
	case "host.roster.conflict_hint":
		return s.Host.Roster.ConflictHint(), true
	case "host.roster.conflict_no_candidates":
		return s.Host.Roster.ConflictNoCandidates(), true
	case "host.roster.conflict_submit":
		return s.Host.Roster.ConflictSubmit(), true
	case "host.roster.conflict_title":
		return s.Host.Roster.ConflictTitle(), true
	...
	case "host.roster.flags_hint":
		return s.Host.Roster.FlagsHint(), true
	case "host.roster.flags_placeholder":
		return s.Host.Roster.FlagsPlaceholder(), true
	case "host.roster.flags_saved_notice":
		return s.Host.Roster.FlagsSavedNotice(), true
	...
	case "host.troikas.add_subhead":
		return s.Host.Troikas.AddSubhead(), true
	case "host.troikas.add_submit":
		return s.Host.Troikas.AddSubmit(), true
	case "host.troikas.col_name":
		return s.Host.Troikas.ColName(), true
	case "host.troikas.col_players":
		return s.Host.Troikas.ColPlayers(), true
	case "host.troikas.col_team":
		return s.Host.Troikas.ColTeam(), true
	case "host.troikas.crumb":
		return s.Host.Troikas.Crumb(), true
	case "host.troikas.delete_seated":
		return s.Host.Troikas.DeleteSeated(), true
	case "host.troikas.deleted_notice":
		return s.Host.Troikas.DeletedNotice(), true
	case "host.troikas.edit_label":
		return s.Host.Troikas.EditLabel(), true
	case "host.troikas.empty":
		return s.Host.Troikas.Empty(), true
	case "host.troikas.hint":
		return s.Host.Troikas.Hint(), true
	case "host.troikas.lines_hint":
		return s.Host.Troikas.LinesHint(), true
	case "host.troikas.lines_label":
		return s.Host.Troikas.LinesLabel(), true
	case "host.troikas.lines_placeholder":
		return s.Host.Troikas.LinesPlaceholder(), true
	case "host.troikas.name_missing":
		return s.Host.Troikas.NameMissing(), true
	case "host.troikas.saved_notice":
		return s.Host.Troikas.SavedNotice(), true
	case "imports.rating.merge_stale":
		return s.Imports.Rating.MergeStale(), true
	...
	case "matchops.seating.not_in_roster":
		return s.Matchops.Seating.NotInRoster(), true
	case "matchops.seating.repeated":
		return s.Matchops.Seating.Repeated(), true
	...
	case "replay.parse.part_block_round":
		return s.Replay.Parse.PartBlockRound(), true
	...
	case "replay.run.draw_unwritable":
		return s.Replay.Run.DrawUnwritable(), true
	...
	case "resolver.draw.already_seated":
		return s.Resolver.Draw.AlreadySeated(), true
	case "resolver.draw.not_a_candidate":
		return s.Resolver.Draw.NotACandidate(), true
	...
	case "scheme.validate.slug_required":
		return s.Scheme.Validate.SlugRequired(), true
	case "scheme.validate.stage_code_required":
		return s.Scheme.Validate.StageCodeRequired(), true
	case "scheme.validate.stages_required":
		return s.Scheme.Validate.StagesRequired(), true
	case "scheme.validate.title_required":
		return s.Scheme.Validate.TitleRequired(), true
	...
	case "screen.division.all":
		return s.Screen.Division.All(), true
	case "screen.division.label":
		return s.Screen.Division.Label(), true
	...
	case "structure.elimination.too_many_block_rounds":
		return s.Structure.Elimination.TooManyBlockRounds(), true
	...
	case "structure.placement.block_rounds_min":
		return s.Structure.Placement.BlockRoundsMin(), true
	case "structure.placement.draw_seat":
		return s.Structure.Placement.DrawSeat(), true
	case "structure.placement.match_size_missing":
		return s.Structure.Placement.MatchSizeMissing(), true
	case "structure.placement.participants_missing":
		return s.Structure.Placement.ParticipantsMissing(), true
	case "structure.placement.table":
		return s.Structure.Placement.Table(), true
	...
	case "structure.se.block_round_semifinals":
		return s.Structure.Se.BlockRoundSemifinals(), true
	...
	case "structure.swiss.needs_ranking":
		return s.Structure.Swiss.NeedsRanking(), true
	case "structure.swiss.table":
		return s.Structure.Swiss.Table(), true
	...
	case "troika.shootout.add":
		return s.Troika.Shootout.Add(), true
	case "troika.shootout.drop":
		return s.Troika.Shootout.Drop(), true
	case "troika.stats.bouts":
		return s.Troika.Stats.Bouts(), true
	case "troika.stats.empty":
		return s.Troika.Stats.Empty(), true
	...
	case "troika.swiss.losses":
		return s.Troika.Swiss.Losses(), true
	case "troika.swiss.place":
		return s.Troika.Swiss.Place(), true
	case "troika.swiss.seed":
		return s.Troika.Swiss.Seed(), true
	case "troika.swiss.wins":
		return s.Troika.Swiss.Wins(), true
	case "troika.title":
		return s.Troika.Title(), true
	case "troika.written.place":
		return s.Troika.Written.Place(), true
	case "troika.written.threes":
		return s.Troika.Written.Threes(), true
	case "troika.written.threes_hint":
		return s.Troika.Written.ThreesHint(), true
	case "troika.written.twos":
		return s.Troika.Written.Twos(), true
	case "troika.written.twos_hint":
		return s.Troika.Written.TwosHint(), true
