...
type OdEntryStrings struct {
	ContestedAdd func() string
	ModeQuestion func() string
	ModeTable    func() string
	Next         func() string
	NoTeams      func() string
	Prev         func() string
	QuestionOf   func(n string, total string) string
	TourQuestion func(tour string, n string, total string) string
	WhoTookIt    func() string
}
...
type VenuesFlagsStrings struct {
	Base          func() string
	BaseOption    func() string
	Captain       func() string
	CaptainOption func() string
	Label         func() string
	Legion        func() string
	LegionOption  func() string
}
...
type VenuesGameStrings struct {
	...
	EditLink              func() string
	EditSummary           func(who string) string
	EditTitle             func(team string) string
	EditedTitle           func(at string) string
	LinkCopy              func() string
	LinkLabel             func() string
	LinkPublicLabel       func() string
	LinkRotate            func() string
	LinkRotateConfirm     func() string
	MessageBody           func(venue string, text string) string
	MessageBtn            func() string
	MessageFailed         func() string
	MessageHint           func() string
	MessageLabel          func() string
	MessageSend           func() string
	MessageTitle          func(who string) string
	RegClosesAtLabel      func() string
	RegClosesLabel        func() string
	RegClosesNever        func() string
	RegDialogTitle        func() string
	RegLinkPublic         func() string
	RegOpenBtn            func() string
	RegOpensAtLabel       func() string
	RegOpensLabel         func() string
	RegOpensNow           func() string
	RegShutBtn            func() string
	RegShutConfirm        func() string
	RegStateClosed        func() string
	RegStateOpen          func() string
	RegStateScheduled     func(at string) string
	RegStateShut          func() string
	RegSubhead            func() string
	RegUntil              func(at string) string
	RosterHide            func() string
	RosterShow            func() string
	...
	TournamentPlaceholder func() string
...
type VenuesHostStrings struct {
	...
	VenuesSubhead          func() string
}

type VenuesMineStrings struct {
	ColGame     func() string
	ColStatus   func() string
	ColTeam     func() string
	...
	EditBtn     func() string
	Empty       func() string
	HereSubhead func() string
	OpenGame    func() string
	Subhead     func() string
}
...
type VenuesRegStrings struct {
	...
	TableBtn              func() string
	TeamAliasLabel        func() string
	TeamAliasPlaceholder  func() string
	TeamAliasToggle       func() string
	TeamKindExisting      func() string
	TeamKindLabel         func() string
	TeamKindNew           func() string
	TeamNameLabel         func() string
	TeamNumber            func(n string) string
	TeamPickRequired      func() string
	TeamSearchPlaceholder func() string
	Title                 func(venue string) string
	WithdrawBtn           func() string
	WithdrawConfirm       func() string
}

type VenuesRosterEditorStrings struct {
	AddPlayer         func() string
	FillBase          func() string
	FillBaseNone      func() string
	FillPrevious      func() string
	FillPreviousNone  func() string
	FillPreviousTitle func() string
...
type VenuesTournamentsStrings struct {
	Chosen             func() string
	DifficultyFrom     func() string
	DifficultyLabel    func() string
	DifficultyTo       func() string
	Empty              func() string
	KeepAria           func() string
	PickBtn            func() string
	PickSubmit         func() string
	SelectAll          func() string
	SortDifficultyDown func() string
	SortDifficultyUp   func() string
	SortLabel          func() string
	SortTeams          func() string
	Subhead            func() string
	TeamsTitle         func() string
	TypeAll            func() string
	TypeAsync          func() string
	TypeLabel          func() string
	TypeSync           func() string
}
...
func (s Strings) Lookup(id string) (string, bool) {
	...
	case "od.entry.contested_add":
		return s.Od.Entry.ContestedAdd(), true
	case "od.entry.mode_question":
		return s.Od.Entry.ModeQuestion(), true
	case "od.entry.mode_table":
		return s.Od.Entry.ModeTable(), true
	case "od.entry.next":
		return s.Od.Entry.Next(), true
	case "od.entry.no_teams":
		return s.Od.Entry.NoTeams(), true
	case "od.entry.prev":
		return s.Od.Entry.Prev(), true
	case "od.entry.who_took_it":
		return s.Od.Entry.WhoTookIt(), true
	case "od.guard.lead":
	...
	case "venues.flags.base_option":
		return s.Venues.Flags.BaseOption(), true
	case "venues.flags.captain":
		return s.Venues.Flags.Captain(), true
	case "venues.flags.captain_option":
		return s.Venues.Flags.CaptainOption(), true
	case "venues.flags.label":
		return s.Venues.Flags.Label(), true
	case "venues.flags.legion":
		return s.Venues.Flags.Legion(), true
	case "venues.flags.legion_option":
		return s.Venues.Flags.LegionOption(), true
	...
	case "venues.game.cancel":
		return s.Venues.Game.Cancel(), true
	...
	case "venues.game.edit_link":
		return s.Venues.Game.EditLink(), true
	case "venues.game.link_copy":
		return s.Venues.Game.LinkCopy(), true
	case "venues.game.link_label":
		return s.Venues.Game.LinkLabel(), true
	case "venues.game.link_public_label":
		return s.Venues.Game.LinkPublicLabel(), true
	...
	case "venues.game.message_btn":
		return s.Venues.Game.MessageBtn(), true
	case "venues.game.message_failed":
		return s.Venues.Game.MessageFailed(), true
	case "venues.game.message_hint":
		return s.Venues.Game.MessageHint(), true
	case "venues.game.message_label":
		return s.Venues.Game.MessageLabel(), true
	case "venues.game.message_send":
		return s.Venues.Game.MessageSend(), true
	case "venues.game.reg_closes_at_label":
		return s.Venues.Game.RegClosesAtLabel(), true
	case "venues.game.reg_closes_label":
		return s.Venues.Game.RegClosesLabel(), true
	case "venues.game.reg_closes_never":
		return s.Venues.Game.RegClosesNever(), true
	case "venues.game.reg_dialog_title":
		return s.Venues.Game.RegDialogTitle(), true
	case "venues.game.reg_link_public":
		return s.Venues.Game.RegLinkPublic(), true
	case "venues.game.reg_open_btn":
		return s.Venues.Game.RegOpenBtn(), true
	case "venues.game.reg_opens_at_label":
		return s.Venues.Game.RegOpensAtLabel(), true
	case "venues.game.reg_opens_label":
		return s.Venues.Game.RegOpensLabel(), true
	case "venues.game.reg_opens_now":
		return s.Venues.Game.RegOpensNow(), true
	case "venues.game.reg_shut_btn":
		return s.Venues.Game.RegShutBtn(), true
	case "venues.game.reg_shut_confirm":
		return s.Venues.Game.RegShutConfirm(), true
	case "venues.game.reg_state_closed":
		return s.Venues.Game.RegStateClosed(), true
	case "venues.game.reg_state_open":
		return s.Venues.Game.RegStateOpen(), true
	case "venues.game.reg_state_shut":
		return s.Venues.Game.RegStateShut(), true
	case "venues.game.reg_subhead":
		return s.Venues.Game.RegSubhead(), true
	case "venues.game.roster_hide":
		return s.Venues.Game.RosterHide(), true
	case "venues.game.roster_show":
		return s.Venues.Game.RosterShow(), true
	...
	case "venues.game.tournament_placeholder":
		return s.Venues.Game.TournamentPlaceholder(), true
	...
	case "venues.host.venues_subhead":
		return s.Venues.Host.VenuesSubhead(), true
	case "venues.mine.col_game":
		return s.Venues.Mine.ColGame(), true
	case "venues.mine.col_status":
		return s.Venues.Mine.ColStatus(), true
	case "venues.mine.col_team":
		return s.Venues.Mine.ColTeam(), true
	case "venues.mine.col_venue":
		return s.Venues.Mine.ColVenue(), true
	case "venues.mine.edit_btn":
		return s.Venues.Mine.EditBtn(), true
	case "venues.mine.empty":
		return s.Venues.Mine.Empty(), true
	case "venues.mine.here_subhead":
		return s.Venues.Mine.HereSubhead(), true
	case "venues.mine.open_game":
		return s.Venues.Mine.OpenGame(), true
	case "venues.mine.subhead":
		return s.Venues.Mine.Subhead(), true
	...
	case "venues.od_contested.contested_label":
		return s.Venues.OdContested.ContestedLabel(), true
	...
	case "venues.public.host_link":
		return s.Venues.Public.HostLink(), true
	...
	case "venues.reg.team_alias_label":
		return s.Venues.Reg.TeamAliasLabel(), true
	case "venues.reg.team_alias_placeholder":
		return s.Venues.Reg.TeamAliasPlaceholder(), true
	case "venues.reg.team_alias_toggle":
		return s.Venues.Reg.TeamAliasToggle(), true
	case "venues.reg.team_kind_existing":
		return s.Venues.Reg.TeamKindExisting(), true
	case "venues.reg.team_kind_label":
		return s.Venues.Reg.TeamKindLabel(), true
	case "venues.reg.team_kind_new":
		return s.Venues.Reg.TeamKindNew(), true
	case "venues.reg.team_name_label":
		return s.Venues.Reg.TeamNameLabel(), true
	case "venues.reg.team_pick_required":
		return s.Venues.Reg.TeamPickRequired(), true
	case "venues.reg.team_search_placeholder":
		return s.Venues.Reg.TeamSearchPlaceholder(), true
	case "venues.reg.withdraw_btn":
		return s.Venues.Reg.WithdrawBtn(), true
	case "venues.reg.withdraw_confirm":
		return s.Venues.Reg.WithdrawConfirm(), true
	case "venues.roster_editor.add_player":
		return s.Venues.RosterEditor.AddPlayer(), true
	case "venues.roster_editor.fill_base":
		return s.Venues.RosterEditor.FillBase(), true
	case "venues.roster_editor.fill_base_none":
		return s.Venues.RosterEditor.FillBaseNone(), true
	case "venues.roster_editor.fill_previous":
		return s.Venues.RosterEditor.FillPrevious(), true
	case "venues.roster_editor.fill_previous_none":
		return s.Venues.RosterEditor.FillPreviousNone(), true
	case "venues.roster_editor.fill_previous_title":
		return s.Venues.RosterEditor.FillPreviousTitle(), true
	...
	case "venues.tournaments.chosen":
		return s.Venues.Tournaments.Chosen(), true
	case "venues.tournaments.difficulty_from":
		return s.Venues.Tournaments.DifficultyFrom(), true
	case "venues.tournaments.difficulty_label":
		return s.Venues.Tournaments.DifficultyLabel(), true
	case "venues.tournaments.difficulty_to":
		return s.Venues.Tournaments.DifficultyTo(), true
	case "venues.tournaments.empty":
		return s.Venues.Tournaments.Empty(), true
	case "venues.tournaments.keep_aria":
		return s.Venues.Tournaments.KeepAria(), true
	case "venues.tournaments.pick_btn":
		return s.Venues.Tournaments.PickBtn(), true
	case "venues.tournaments.pick_submit":
		return s.Venues.Tournaments.PickSubmit(), true
	case "venues.tournaments.select_all":
		return s.Venues.Tournaments.SelectAll(), true
	case "venues.tournaments.sort_difficulty_down":
		return s.Venues.Tournaments.SortDifficultyDown(), true
	case "venues.tournaments.sort_difficulty_up":
		return s.Venues.Tournaments.SortDifficultyUp(), true
	case "venues.tournaments.sort_label":
		return s.Venues.Tournaments.SortLabel(), true
	case "venues.tournaments.sort_teams":
		return s.Venues.Tournaments.SortTeams(), true
	case "venues.tournaments.subhead":
		return s.Venues.Tournaments.Subhead(), true
	case "venues.tournaments.teams_title":
		return s.Venues.Tournaments.TeamsTitle(), true
	case "venues.tournaments.type_all":
		return s.Venues.Tournaments.TypeAll(), true
	case "venues.tournaments.type_async":
		return s.Venues.Tournaments.TypeAsync(), true
	case "venues.tournaments.type_label":
		return s.Venues.Tournaments.TypeLabel(), true
	case "venues.tournaments.type_sync":
		return s.Venues.Tournaments.TypeSync(), true
