...
func (s Strings) Lookup(id string) (string, bool) {
	...
	case "venues.tournaments.keep_label":
		return s.Venues.Tournaments.KeepLabel(), true
	case "venues.tournaments.no_difficulty":
		return s.Venues.Tournaments.NoDifficulty(), true
	case "venues.tournaments.no_teams":
		return s.Venues.Tournaments.NoTeams(), true
