...
func (s Strings) Lookup(id string) (string, bool) {
	...
	case "venues.game.reg_none":
		return s.Venues.Game.RegNone(), true
	...
	case "venues.game.reg_setup_btn":
		return s.Venues.Game.RegSetupBtn(), true
	...
	case "venues.tournaments.deselect_all":
		return s.Venues.Tournaments.DeselectAll(), true
