...
var RU = Strings{
	...
	Export: ExportStrings{
		...
		Od: ExportOdStrings{
			...
			PlayersCity:       func() string { return "Город" },
			PlayersFirstName:  func() string { return "Имя" },
			PlayersFlag:       func() string { return "Флаг" },
			PlayersName:       func() string { return "Название" },
			PlayersPatronymic: func() string { return "Отчество" },
			PlayersPlace:      func() string { return "Место" },
			PlayersSurname:    func() string { return "Фамилия" },
	...
	Host: HostStrings{
		...
		Profile: HostProfileStrings{
			TzHint: func() string {
				return "В этом поясе записывается время игр и голосований; календарь показывает его под сеткой."
			},
			TzSave:    func() string { return "Сохранить" },
			TzSaved:   func() string { return "Часовой пояс сохранён." },
			TzSubhead: func() string { return "Часовой пояс" },
		},
		PublicTabs: HostPublicTabsStrings{
			Fests:  func() string { return "Фесты" },
			Venues: func() string { return "Синхроны" },
		},
	...
	Od: OdStrings{
		Contested: OdContestedStrings{
			NeedQuestionAndTeam: func() string { return "нужны номер вопроса и номер команды" },
			NoSuchNumber:        func() string { return "в игре нет команды с таким номером" },
		},
	...
	Screen: ScreenStrings{
		...
		Venue: ScreenVenueStrings{
			Trail: func() string { return "Синхроны" },
		},
	},
	...
	Venues: VenuesStrings{
		Contested: VenuesContestedStrings{
			Accept:        func() string { return "Принять на площадке" },
			ColAccepted:   func() string { return "Принят" },
			ColAnswer:     func() string { return "Ответ" },
			ColQuestion:   func() string { return "Вопрос" },
			ColTeam:       func() string { return "Команда" },
			ColTour:       func() string { return "Тур" },
			Delete:        func() string { return "Удалить" },
			DeleteConfirm: func() string { return "Удалить спорный?" },
			Empty:         func() string { return "Спорных нет." },
			StateAccepted: func() string { return "принят на площадке" },
			StatePending:  func() string { return "ждёт жюри" },
			Subhead:       func() string { return "Спорные" },
			Unaccept:      func() string { return "Снять принятие" },
		},
		Errors: VenuesErrorsStrings{
			GameEntered:         func(n string) string { return fmt.Sprintf("введён вопрос %s", n) },
			GameNotStarted:      func() string { return "игра не началась" },
			NeedsTeamNumber:     func() string { return "нужен номер команды" },
			NoTeamName:          func() string { return "укажите название команды" },
			RatingNoVenue:       func() string { return "такой площадки нет на rating.chgk.info" },
			RatingUnavailable:   func() string { return "rating.chgk.info не ответил" },
			RatingVenueRequired: func() string { return "Выберите площадку на rating.chgk.info." },
			TeamHasResults: func() string {
				return "у команды уже есть результаты в игре — сначала уберите их"
			},
		...
		Game: VenuesGameStrings{
			...
			CloneTitle:    func() string { return "Клонировать игру" },
			ColFiled:      func() string { return "Подана" },
			ColFlags:      func() string { return "Флаги" },
			ColNumber:     func() string { return "№" },
			ColRoster:     func() string { return "Состав" },
			ColStatus:     func() string { return "Статус" },
			ColSubmitter:  func() string { return "Кто подал" },
			ColTeam:       func() string { return "Команда" },
			ColWho:        func() string { return "Кто" },
			DatetimeLabel: func() string { return "Дата и время" },
			DeleteConfirm: func() string {
				return "Удалить игру? Заявки, составы, голосование и результаты будут удалены."
			},
			DeleteSubmit:     func() string { return "Удалить игру" },
			DownloadPlayers:  func() string { return "Игроки (xlsx)" },
			DownloadTours:    func() string { return "Туры (xlsx)" },
			DownloadsSubhead: func() string { return "Выгрузки" },
			EditLink:         func() string { return "Редактировать заявку" },
			EditSummary:      func(who string) string { return fmt.Sprintf("Подал %s", who) },
			EditTitle:        func(team string) string { return fmt.Sprintf("Заявка · %s", team) },
			EditedTitle:      func(at string) string { return fmt.Sprintf("изменена %s", at) },
			...
			RegShutBtn:       func() string { return "Закрыть регистрацию" },
			RegShutConfirm: func() string {
				return "Закрыть регистрацию? Заявки перестанут приниматься."
			},
			...
			RegStateShut:          func() string { return "Закрыта вручную" },
			RegSubhead:            func() string { return "Регистрация" },
			RegUntil:              func(at string) string { return fmt.Sprintf("до %s", at) },
			RosterHide:            func() string { return "Скрыть составы" },
			RosterShow:            func() string { return "Показать составы" },
			...
			Subhead:               func() string { return "Игра" },
			TableBtn:              func() string { return "Таблица игры" },
			TournamentLabel:       func() string { return "Турнир на rating.chgk.info" },
		...
		Host: VenuesHostStrings{
			...
			CreateVenueSubmit:  func() string { return "Создать" },
			CreateVenueSummary: func() string { return "Создать площадку" },
			DeleteSubhead:      func() string { return "Удаление" },
			DeleteVenueConfirm: func() string {
				return "Удалить площадку? Все игры, заявки и результаты будут удалены."
			},
			DeleteVenueSubmit:      func() string { return "Удалить площадку" },
			DescriptionLabel:       func() string { return "Описание (markdown)" },
			GameAccepted:           func(n string) string { return fmt.Sprintf(" · принято %s", n) },
			GameNoTournament:       func() string { return "турнир не выбран" },
			GamePending:            func(n string) string { return fmt.Sprintf(", ждут %s", n) },
			GameUndated:            func() string { return "без даты" },
			GamesEmpty:             func() string { return "Игр пока нет." },
			GamesSubhead:           func() string { return "Игры" },
			JumpLabel:              func() string { return "Страница площадки" },
			JumpTitle:              func() string { return "Открыть страницу площадки" },
			NewGameSubmit:          func() string { return "Создать игру" },
			NewGameSummary:         func() string { return "Новая игра" },
			PageTitle:              func(title string) string { return fmt.Sprintf("%s · площадка", title) },
			PublicLabel:            func() string { return "Публичная" },
			RatingVenueLabel:       func() string { return "Площадка на rating.chgk.info" },
			RatingVenuePlaceholder: func() string { return "город, название или id" },
			SaveSubmit:             func() string { return "Сохранить" },
			SlugHint: func() string {
				return "Только латиница в нижнем регистре, цифры и дефис; не одни цифры"
			},
			SlugLabel:     func() string { return "Slug (URL вида /venue/{slug})" },
			TitleLabel:    func() string { return "Название" },
			VenueUnlisted: func() string { return "непубличная" },
			VenuesEmpty:   func() string { return "Площадок пока нет." },
			VenuesSubhead: func() string { return "Площадки" },
		},
		Mine: VenuesMineStrings{
			ColGame:     func() string { return "Игра" },
			ColStatus:   func() string { return "Статус" },
			ColTeam:     func() string { return "Команда" },
			ColVenue:    func() string { return "Площадка" },
			EditBtn:     func() string { return "Изменить" },
			Empty:       func() string { return "Вы пока не подали ни одной заявки." },
			HereSubhead: func() string { return "Мои игры на этой площадке" },
			OpenGame:    func() string { return "Таблица" },
			Subhead:     func() string { return "Мои заявки" },
		},
		OdContested: VenuesOdContestedStrings{
			AcceptedLabel:  func() string { return "Принят на площадке" },
			AnswerLabel:    func() string { return "Ответ" },
			ContestedLabel: func() string { return "Спорный" },
			DialogTitle:    func(n string) string { return fmt.Sprintf("Спорный ответ · вопрос %s", n) },
			NoSuchTeam:     func() string { return "Нет такой команды" },
			NumberLabel:    func() string { return "Номер команды" },
			Remove:         func() string { return "Удалить" },
			Save:           func() string { return "Сохранить" },
			SaveFailed:     func() string { return "Не удалось сохранить спорный ответ" },
		},
		Public: VenuesPublicStrings{
			ColCity:           func() string { return "Город" },
			ColNextGame:       func() string { return "Ближайшая игра" },
			ColRating:         func() string { return "Рейтинг" },
			ColRegistration:   func() string { return "Регистрация" },
			ColTeams:          func() string { return "Команд" },
			ColTournament:     func() string { return "Турнир" },
			ColVenue:          func() string { return "Площадка" },
			ColWhen:           func() string { return "Когда" },
			GamesEmpty:        func() string { return "Игр пока нет." },
			HostLink:          func() string { return "режим организатора" },
			IndexEmpty:        func() string { return "Публичных площадок пока нет." },
			IndexTitle:        func() string { return "Синхроны" },
			PastGames:         func() string { return "Прошедшие игры" },
			RatingLink:        func() string { return "страница площадки на турнирном сайте" },
			RegClosed:         func() string { return "закрыта" },
			RegOpen:           func() string { return "открыта" },
			RegScheduled:      func(at string) string { return fmt.Sprintf("откроется %s", at) },
			SearchLabel:       func() string { return "Поиск" },
			SearchPlaceholder: func() string { return "город, название…" },
			UpcomingGames:     func() string { return "Ближайшие игры" },
		},
		Reg: VenuesRegStrings{
			ApplicationSubhead:   func() string { return "Заявка" },
			Closed:               func() string { return "Регистрация закрыта." },
			ColFlag:              func() string { return "Флаг" },
			ColId:                func() string { return "ID" },
			ColPlayer:            func() string { return "Игрок" },
			Crumb:                func() string { return "Регистрация" },
			...
			StatusDeclined:       func() string { return "отклонена" },
			StatusLine:           func(status string) string { return fmt.Sprintf("Статус: %s", status) },
			StatusPending:        func() string { return "на рассмотрении" },
			SubmitEdit:           func() string { return "Сохранить заявку" },
			SubmitNew:            func() string { return "Подать заявку" },
			TableBtn:             func() string { return "Таблица игры" },
			TeamAliasLabel:       func() string { return "Разовое название" },
			TeamAliasPlaceholder: func() string { return "как объявить команду на этой игре" },
			TeamAliasToggle:      func() string { return "Добавить разовое название" },
			...
			WithdrawBtn:           func() string { return "Отозвать заявку" },
			WithdrawConfirm: func() string {
				return "Отозвать заявку? Её придётся подавать заново."
			},
		},
		RosterEditor: VenuesRosterEditorStrings{
			...
			FillPreviousNone:  func() string { return "Прежних составов нет." },
			FillPreviousTitle: func() string { return "Предыдущие составы" },
		...
		Voting: VenuesVotingStrings{
			...
			BallotRestore:  func() string { return "Вернуть" },
			BallotsSubhead: func() string { return "Голоса" },
			BuffEmpty: func() string {
				return "Буфф не знает турниров на эту дату — добавьте по id."
			},
			ClosesLabel:  func() string { return "Закрывается" },
			ColChoice:    func() string { return "Выбор" },
			ColWho:       func() string { return "Кто" },
			CopyLink:     func() string { return "Копировать" },
			CreateSubmit: func() string { return "Создать голосование" },
			DeclinedNote: func() string {
				return "Ваш голос отклонён представителем площадки."
			},
			Empty: func() string { return "Голосования нет." },
			ErrorFrozen: func() string {
				return "по голосованию уже голосовали — вид и режим менять нельзя"
			},
			ErrorKindUnknown:   func() string { return "неизвестный вид голосования" },
			ErrorNoTournaments: func() string { return "выберите хотя бы один турнир" },
			ErrorPickOne:       func() string { return "Выберите хотя бы один турнир." },
			FrozenNote: func() string {
				return "По голосованию уже голосовали: турниры, вид и режим больше не меняются."
			},
			KindAny:          func() string { return "любые" },
			KindLabel:        func() string { return "Сколько можно выбрать" },
			KindLine:         func(kind string) string { return fmt.Sprintf("Вид: %s", kind) },
			KindOne:          func() string { return "ровно один" },
			KindRanked:       func() string { return "три по порядку" },
			OpensLabel:       func() string { return "Открывается" },
			OpensPlaceholder: func() string { return "сразу" },
			PageClosed:       func() string { return "Голосование закрыто." },
			PageLogin:        func() string { return "Чтобы проголосовать, войдите через Telegram." },
			PageScheduled:    func(at string) string { return fmt.Sprintf("Голосование откроется %s.", at) },
			PageTitle:        func(venue string) string { return fmt.Sprintf("Голосование · %s", venue) },
			PerTeamLabel:     func() string { return "Голосуют команды, а не люди" },
			PickAny:          func() string { return "Во что готовы играть" },
			PickOne:          func() string { return "Во что играем" },
			RankFirst:        func() string { return "Первое место" },
			RankSecond:       func() string { return "Второе место" },
			RankThird:        func() string { return "Третье место" },
			SaveSubmit:       func() string { return "Сохранить голосование" },
			SettingsSummary:  func() string { return "Настройки голосования" },
			Subhead:          func() string { return "Голосование" },
			SubmitEdit:       func() string { return "Изменить голос" },
			SubmitNew:        func() string { return "Проголосовать" },
			TallySubhead:     func() string { return "Итог" },
			TournamentN:      func(id string) string { return fmt.Sprintf("Турнир %s", id) },
			TournamentsLabel: func() string { return "Турниры" },
			WindowFrom:       func(at string) string { return fmt.Sprintf("с %s", at) },
			WindowNone:       func() string { return "без срока" },
			WindowUntil:      func(at string) string { return fmt.Sprintf("до %s", at) },
			YourBallot:       func() string { return "Ваш голос" },
		},
	},
