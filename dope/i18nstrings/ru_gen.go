...
var RU = Strings{
	...
	Venues: VenuesStrings{
		...
		Game: VenuesGameStrings{
			...
			LinkSubhead:         func() string { return "Ссылка на регистрацию" },
			LinkVisibleLabel:    func() string { return "Ссылка видна" },
			RegClosedLabel:      func() string { return "Регистрация закрыта" },
			...
			TournamentLabel:     func() string { return "ID турнира на rating.chgk.info" },
		...
		RosterEditor: VenuesRosterEditorStrings{
			...
			TeamPlaceholder:   func() string { return "поиск по названию" },
