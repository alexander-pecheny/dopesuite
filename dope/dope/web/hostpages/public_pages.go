...
// PublicTabs is the public tree's two halves — the fests and the Venues —
...
func PublicTabs(here string) *ui.Element {
	...
	return ui.Tabs(tab("/", strs.Host.PublicTabs.Fests()), tab("/venues", strs.Host.PublicTabs.Venues()))
}
