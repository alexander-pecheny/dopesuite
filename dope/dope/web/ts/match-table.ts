...
// SSE state sync, floating popovers, virtual keypads. Converted from the legacy
// match-table.js IIFE; consumers import DopeTable (or the named exports) instead
// of reading window.DopeTable.
