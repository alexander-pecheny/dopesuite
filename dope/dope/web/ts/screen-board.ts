...
export const CITY_COUNTRY: Record<string, string> = {
  ...
  "рим": "IT", "милан": "IT", "вена": "AT",
  "цюрих": "CH", "женева": "CH", "базель": "CH", "берн": "CH", "лозанна": "CH",
  "люцерн": "CH", "винтертур": "CH", "санкт-галлен": "CH", "лугано": "CH",
  "арау": "CH", "аарау": "CH", "цуг": "CH", "тун": "CH", "фрибур": "CH",
  "невшатель": "CH", "биль": "CH",
  "стокгольм": "SE", "осло": "NO", "копенгаген": "DK", "орхус": "DK",
