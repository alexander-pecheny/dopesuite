...
export type Strings = {
  ...
  venues: {
    ...
    game: {
      ...
      editLink: () => string;
      editSummary: (who: string) => string;
      editTitle: (team: string) => string;
      ...
      messageBody: (venue: string, text: string) => string;
      messageBtn: () => string;
      messageFailed: () => string;
      messageHint: () => string;
      messageLabel: () => string;
      messageSend: () => string;
      messageTitle: (who: string) => string;
      regClosesAtLabel: () => string;
      regClosesLabel: () => string;
